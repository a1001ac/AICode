  ...
  <div id="appChatPage">
    ...
    <div class="header-bar">
      ...
      <div class="header-right">
        <a-button type="default" @click="showAppDetail" class="action-button">
          <template #icon>
            <InfoCircleOutlined />
          </template>
          应用详情
      ...
      <div class="preview-section card-container">
        ...
        <div class="preview-content">
          <div v-if="!previewUrl && !isGenerating" class="preview-placeholder">
            ...
            <p>网站文件生成完成后将在这里展示</p>
            <a-button type="primary" @click="sendMessage" :disabled="!userInput.trim()">
          ...
          <div v-else-if="isGenerating" class="preview-loading">
            ...
            <div class="generation-progress">
              <a-progress :percent="generationProgress" :show-info="false" />
            </div>
          </div>
          <iframe
            v-else
...
.edit-mode-active:hover {
  background: linear-gradient(90deg, #73d13d, #389e0d) !important;
}
