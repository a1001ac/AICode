...
import com.ermao.aicode.constant.CommonConstant;
...
public class IpUtil {
    ...
    public static String getCityInfo(String ip)  {
        ...
        String address = CommonConstant.UNKNOWN;
        if(status == 0){
    ...
    public static String getIp2region(String ip)  {
        ...
        String ipInfo = CommonConstant.UNKNOWN;
        try {
    ...
    public static void main(String[] args) {
        System.out.println(getIp2region("101.126.151.232"));
        System.out.println(getCityInfo("101.126.151.232"));
    }
    /**
     * 获取访问设备
     *
