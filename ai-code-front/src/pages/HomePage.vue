...
const viewChat = (app: API.AppVO) => {
  ...
  if (
    ...
    loginUserStore.loginUser.id !== app.userId
  ) {
    ...
    <div class="container">
      ...
      <div class="quick-actions">
        ...
        <a-button
          ...
          @click="
            setPrompt(
              '使用Vue3构建一个功能完整的秒杀商城，包含商品展示、购物车、用户注册登录、订单管理、支付结算功能。设计现代化的商品卡片布。',
            )
          "
        >秒杀商城</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '使用Vue3开发一个 AI 流式对话界面，用于展示大语言模型的交互能力。需要支持实时流式响应， 用户与 AI 对话点击发送按钮，流式显示大模型返回结果,大模型返回数据可能为文本，可以查看消息历史记录，添加在代码块有复制功能等。',
            )
          "
        >AI对话网站</a-button
        >
