...
/** 此处后端没有提供注释 GET /app/count */
export async function getAppCount(options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>('/app/count', {
    method: 'GET',
    ...(options || {}),
  })
}

/** 此处后端没有提供注释 GET /app/count/type */
export async function getCountByCodeGenType(options?: { [key: string]: any }) {
  return request<API.BaseResponseMapStringLong>('/app/count/type', {
    method: 'GET',
    ...(options || {}),
  })
}
